...
import { Target, Plus, Eye, Pencil, PlayCircle, Lock } from 'lucide-react';
...
const TargetPageInner = () => {
  ...
  const { data, isLoading, isError } = useTargetBranches({ period }, branchHeader, branchKey);
  ...
  return (
    <div className="max-w-[1600px] mx-auto space-y-5">
      ...
      <ConfirmDialog
        ...
        onConfirm={() => confirmActivate && m.activate.mutate(confirmActivate.id, { onError: (e) => notifyApiError(e) })}
      ...
      <ConfirmDialog
        ...
        onConfirm={() => confirmClose && m.close.mutate(confirmClose.id, { onError: (e) => notifyApiError(e) })}
        title="Tutup Target"

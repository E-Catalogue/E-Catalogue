...
import type { TestDrive, TestDriveListParams, TestDriveSalesLookup, TestDriveUnitLookup } from './testDrive.types';
...
export const testDriveApi = {
  ...
  sales: () =>
    apiClient.get<ApiResponse<TestDriveSalesLookup[]>>('/test-drives/sales').then((r) => r.data.data),
